...
function App() {
  ...
  return (
    ...
    >
      <div className="w-full h-3/5 flex justify-around items-center gap-1 max-sm:flex-col">
        {/* <img
          src="https://images.pexels.com/photos/5698697/pexels-photo-5698697.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
          className="w-2/5 h-4/5 rounded-xl ml-3 max-sm:w-4/5"
          alt=""
        /> */}
        <div className="w-full max-w-lg  mx-2 h-4/5 border border-gray-600 rounded-lg p-2 backdrop-blur-sm bg-white/30 flex justify-center items-center max-sm:w-4/5">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              convert();
